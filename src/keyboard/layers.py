...
class MyLayerHandler(InputHandler):
    ...
    def __init__(self, debug=False):
        ...
        self_dict = {"<space>": "<space>", "<tab>": "<tab>", "<enter>": "<enter>", "<esc>": "<esc>", 
        ...
        control_bindings = self.generate_remap_control_press(self_dict, nothing)
        ...
        get_control_bindings = make_wrapper({**control_bindings, **standard_bindings})
        get_super_bindings = make_wrapper({**super_bindings, **standard_bindings})
        ...
        self.base_layer = Layer(
            ...
            union(control_z.modifiers).union(control_slash.modifiers).union(super_x.modifiers).
            union(super_dot.modifiers).union(shift_l.modifiers).union(shift_r.modifiers)
        )
