    ...
    def create_switch_to_self_modified(self, switch_key):
        def switch_to_self_modified():
            ...
            self.handler.layer = self.Layer(bindings={
                ...
                **self.no_callback_remaps, (switch_key, KeyEvent.key_up):
                self.switch_to_self,
                (switch_key, KeyEvent.key_down):
                lambda: print(self.name, "MODIFIER WAS PRESSED NOT EXPECTED"),
                (switch_key, KeyEvent.key_hold):
                nothing,
